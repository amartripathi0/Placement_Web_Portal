...
const LoginCollege = () => {
  ...
  return (
    ...
    {/* {isLoading && <LoadingPage height = "screen" width= "screen"/>} */}
     ...
     <h1 className="text-2xl text-center">College-Staff Login</h1>
      ...
      <button type ="submit" className='border-2 bg-blue-400 border-black w-full text-xl p-3 pt-1 pb-1 mt-3 rounded-lg'>Submit</button>
         <p className=" font-semibold mt-2">Don't have an account? <span  onClick = {() => navigate('/signup/college-staff')} className="text-blue-800 underline">Signup</span></p>
          </div>
      </div>
