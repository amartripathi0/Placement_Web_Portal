...
const Resume = () => {
  ...
  return (
    <div
      className={` bg-purple-100 gap-10 py-10 flex flex-col justify-center items-center ${
    ...
    >
      ...
      <div className="bg-slate-100  w-[95%] h-full p-20 rounded-lg shadow-slate-300 shadow-md ">
        <div className="bg-white w-full p-10 rounded-md min-h-full">
          <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.4.120/build/pdf.worker.min.js">
            ...
            <Viewer fileUrl={`${student?.resume  ? student.resume : "https://www.adobe.com/support/products/enterprise/knowledgecenter/media/c4611_sample_explain.pdf"} `} />;
          </Worker>
        </div>
      </div>
      {/* <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.4.120/build/pdf.worker.min.js">
